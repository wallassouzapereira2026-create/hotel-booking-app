...
export default function BookingForm({ onSubmit, totalPrice, paymentLink100, paymentLink30Pix, depositPercentage = 30, clientName, clientEmail, clientPhone, clientCpf, details, propertyName, roomType, breakfastIncluded, freeCancellationDate, mainGuestName, guestCount }: BookingFormProps) {
              ...
              {paymentLink30Pix && (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h4 className="font-bold text-foreground text-sm">
                            Pagar {depositPercentage}% agora via PIX
                          </h4>
                          <p className="text-xs text-muted-foreground mt-1">
                            Pague apenas {depositPercentage}% da reserva e o restante na chegada
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-primary text-lg">
